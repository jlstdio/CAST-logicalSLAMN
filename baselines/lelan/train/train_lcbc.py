...
from model.nomad.nomad import DenseNetwork

from baselines.lelan.train.vint_train.data.lcbc_dataset import LCBCDataset
from baselines.lelan.train.vint_train.models.nomad.nomad_vint import replace_bn_with_gn
from baselines.lelan.train.vint_train.training.train_eval_loop_lelan import train_eval_loop_lelan, load_model
        ...
        for data_split_type in ["train", "test"]:
            if data_split_type in data_config:
                    dataset = LCBCDataset(
                        ...
                        traj_file=data_config["traj_file"],
                    )
